...
const todo3: Todo = { id: 103, title: "Fare esercizio fisico", completed: false, status: TodoStatus.Pending };
const todo4: Todo = { id: 104, title: "Studiare TypeScript", completed: false, status: TodoStatus.Pending };
